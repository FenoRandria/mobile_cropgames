  ...
  return (
    <>
      ...
      <main>
        <header>
          <div className="logo">
            <img src={LogoWhiteImage} alt="Logo de CropGames" />
          </div>
          <div className="title">
            <h1>CropGames: Cultivez Votre Ville <br /><span>À Votre Façon</span></h1>
          </div>
        </header>
        <section className="contenu">
          <div className="image-contenu">
            <p>
              <span>CropGames vous offre une expérience de jeu immersive</span> 
              où vous pouvez cultiver votre propre ville, gérer vos terrains, et développer votre ferme de manière innovante. Découvrez comment ajouter de nouveaux terrains et faire croître vos cultures pour réussir dans CropGames.
            </p>
          </div>
        </section>
        <section className="action">
          <ButtonGround
            sary={leftUp}
            href="/cropgames/landList"
            nameClass="button"
            contenu="Voir la Liste des Champs dans CropGames"
          />
          <ButtonGround
            sary={add}
            href="/cropgames/addTerrain"
            nameClass="button"
            contenu="Ajouter un Nouveau Terrain à CropGames"
          />
        </section>
      </main>
    </>
